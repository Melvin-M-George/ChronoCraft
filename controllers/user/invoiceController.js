...
const generateHeader = (doc) => {
    doc
        .image("D:/Vscode projects/Chronocraft/public/Images/ChronoCraft/logo-transparent-png.png", 50, 45, { width: 50 })
        .fillColor('#444444')
        .fontSize(20)
        .text('ChronoCraft', 110, 57)
        .fontSize(10)
        .text('ChronoCraft', 200, 50, { align: 'right' })
        .moveDown();
